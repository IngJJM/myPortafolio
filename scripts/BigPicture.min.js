var BigPicture = function () {
    ...
    function W() {
        ...
        ) + "px, 0) scale3D(" + t.clientWidth / o.clientWidth + ", " + t.clientHeight / o.clientHeight + ", 0)"
    }
    function q(t) {
        var n = A.length - 1;
        if (! u) {
            if (t > 0 && E === n || t < 0 && ! E) {
                if (! C.loop) 
                    return j(i, ""),
                    void setTimeout(j, 9, i, "animation:" + (
                    t > 0 ? "bpl" : "bpf"
    ...
    function G(t) { ~ [1, 4].indexOf(o.readyState) ? (U(), setTimeout(function () {
            o.play()
    ...
    function Y(t) {
        ...
        n.blur(),
        w ||~ i.indexOf(n) || (o.style.cssText += W(), j(e, "pointer-events:auto"), setTimeout($, 350), clearTimeout(k), v = 0, w = 1)
    }
    function $() {
    ...
    return function (w) {
        ...
        return n || function () {
            ...
            l = s("bp-x"),
            e[O](l),
            "ontouchstart" in window && (z = 1, e.ontouchstart = function (n) {
            ...
            document.addEventListener("keyup", function (t) {
                var n = t.keyCode;
                27 === n && v && Y(),
                y && (39 === n && q(1), 37 === n && q(-1), 38 === n && q(10), 40 === n && q(-10))
            }),
